...
main = do
    ...
    let name1 = extractName code (parenIdx - 1) (parenIdx - 1)
    putStrLn $ "extractName code (parenIdx - 1) (parenIdx - 1): " ++ show name1
    
    let name2 = extractName code parenIdx (parenIdx - 1)
    putStrLn $ "extractName code parenIdx (parenIdx - 1): " ++ show name2