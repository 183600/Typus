...
def fix_all_test_errors():
    ...
    for file_path in test_files:
        ...
        try:
            ...
            # 移除第二个 instance Arbitrary Compiler.Errors.Core.TypeError
            pattern1 = r'instance Arbitrary Compiler\.Errors\.Core\.TypeError where\s+return \$ Compiler\.Errors\.Core\.TypeError context message'
            replacement1 = '-- Removed duplicate Arbitrary instance'
            ...
            # 将 [Compiler.Errors.Core.TypeError] 替换为 [TypeError]
