...
instance Arbitrary SourceSpan where
  arbitrary = do
    ...
    , testGroup "Go module Test.Unit.GoToolchainIntegrationSpec
        [             testCase "creates go.mod file with correct content" $ do
            ...
            result <- runExceptT $ withTemporaryGoProject "typus-test" $ \tempDir -> do
                ...
                liftIO $ do
                    ...
                    assertBool "go.mod should contain module Test.Unit.GoToolchainIntegrationSpec $ 
                        "module Test.Unit.GoToolchainIntegrationSpec `L.isInfixOf` content
    ...
    , testGroup "Property-based tests"
        ...
        , fastProperty "go module Test.Unit.GoToolchainIntegrationSpec is consistent" prop_goModuleConsistent
...
-- | Property: go module Test.Unit.GoToolchainIntegrationSpec is consistent
prop_goModuleConsistent :: String -> Bool
prop_goModuleConsistent                               _ = 
    "module Test.Unit.GoToolchainIntegrationSpec `L.isInfixOf` goModContents && 
