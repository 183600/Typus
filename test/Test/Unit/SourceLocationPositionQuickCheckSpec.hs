...
prop_pos_at_line_col_consistency line column offset =
  ...
  let pos1 = posAt line column offset
      pos2 = posAtLineCol line column offset
  in pos1 === pos2
...
prop_advance_pos_by_text_consistency s pos =
  advancePosByText s pos === advancePos s pos
