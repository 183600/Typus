...
tests =
  testGroup "Type system"
    ...
    , fastProperty "solveConstraints accepts reflexive equalities" propReflexiveConstraints
    , fastProperty "solveConstraints clears pending constraints" propPendingConstraintsCleared
    ]
