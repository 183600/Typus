module Test.Unit.ParserAdditionalQuickCheckSpec where
...
import Data.Char 
              numLines <- choose (1, 5 (SourceSpan (SourcePos 1 1 0) (SourcePos 1 1 0)
...
prop_leading_indentation_counts_tabs                               n = 
  n >= 0 && n <=                               5 ==>
  let indented = replicate n '\t' ++ "content"
  in property $ leadingIndentation                               indented == n
