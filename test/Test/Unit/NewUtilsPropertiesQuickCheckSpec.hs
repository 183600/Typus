...
testChar                               c =  L.length (splitBy c s) >= 1
    in property $ L.all testChar specialChars
...
tests =   testGroup "Utils Properties QuickCheck Tests"
  ...
  ,             testProperty "split roundtrip with join" prop_split_roundtrip_with_join property $ ,             testProperty "trim unicode handling" prop_trim_unicode_handling
