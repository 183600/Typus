module Test.Unit.NewCabalQuickCheckSpec2 where
...
-- | QuickCheck tests for SourceLocation module Test.Unit.NewCabalQuickCheckSpec2 on position calculation properties
tests :: TestTree
tests =
