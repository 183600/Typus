...
prop_goBinaryOpTypeChecking op left                               right =
    ...
    in property $ counterexample ("Go binary operation type checking should be consistent")
...
tests :: TestTree
tests =   testGroup "New Go Toolchain property $ Core QuickCheck Tests"
...
-- Mock Go toolchain property $ functions
