...
-- Test cross-module Test.Unit.NewIntegrationAdvancedQuickCheckSpec properties
...
-- Helper functions (these would need to be implemented in property $ IntegratedCompiler module)
