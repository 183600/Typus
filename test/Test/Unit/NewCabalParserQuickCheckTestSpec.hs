module Test.Unit.NewCabalParserQuickCheckTestSpec where
...
genFileDirectiveLine :: Gen String
  ...
  let directives = L.filter (not . null (SourceSpan (SourcePos 1 1 0 [] (SourcePos 1 1 0) [ownership, dependentTypes, constraints]
  case directives of
    [] -> return "//!"
