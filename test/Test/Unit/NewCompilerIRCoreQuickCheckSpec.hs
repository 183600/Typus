...
-- | IR generation property tests for Compiler module Test.Unit.NewCompilerIRCoreQuickCheckSpec Test.Unit.NewCompilerIRCoreQuickCheckSpec where
import Test.Tasty
import Test.Tasty.QuickCheck
import Compiler

ied Compiler.IR as IR
