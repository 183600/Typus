...
-- Additional generators for DependentTypes testing
genTypeVar :: Gen TypeVar
genTypeVar = TypeVar <$> genIdentifier

genTypeExpression :: Gen TypeExpression
genTypeExpression = oneof
  [ TypeVar <$> genTypeVar
  , TypeConstructor <$> genIdentifier <*> listOf genTypeExpression
  , TypeFunction <$> listOf genTypeExpression <*> genTypeExpression
  , TypeDependent <$> genIdentifier <*> genTypeExpression <*> genTypeExpression
  , TypeRefined <$> genTypeExpression <*> genIdentifier <*> genTypeExpression
  ]
...
genTypeConstraint = oneof
  ...
  , DependentConstraint <$> genIdentifier <*> genTypeExpression <*> genTypeExpression
  , ArithmeticConstraint <$> genArithmeticExpression <*> genArithmeticOperator <*> genArithmeticExpression
  ]

genArithmeticExpression :: Gen ArithmeticExpression
genArithmeticExpression = oneof
