...
-- | Property tests for Utils module Test.Unit.CoreQuickCheckPropertiesSpec :: TestTree
...
-- | Property tests for SourceLocation module Test.Unit.CoreQuickCheckPropertiesSpec :: TestTree
