...
import Data.Text 
  in L.all (\dep -> hasDependency graph module Test.Unit.NewDependenciesAdvancedQuickCheckSpec dependencies &&
...
prop_dependency_detection_transitive_closure graph                               module Test.Unit.NewDependenciesAdvancedQuickCheckSpec 
  hasModule graph                               module Test.Unit.NewDependenciesAdvancedQuickCheckSpec 
  let direct = getDirectDependencies graph module Test.Unit.NewDependenciesAdvancedQuickCheckSpec = getTransitiveDependencies graph module Test.Unit.NewDependenciesAdvancedQuickCheckSpec Set.fromList direct `Set.isSubsetOf` Set.fromList transitive

prop_dependency_detection_no_self_dependencies :: DependencyGraph -> String -> Property
prop_dependency_detection_no_self_dependencies graph                               module Test.Unit.NewDependenciesAdvancedQuickCheckSpec 
  hasModule graph                               module Test.Unit.NewDependenciesAdvancedQuickCheckSpec 
  let dependencies = getDirectDependencies graph module Test.Unit.NewDependenciesAdvancedQuickCheckSpec not (module Test.Unit.NewDependenciesAdvancedQuickCheckSpec dependencies)
...
prop_dependency_analysis_computes_levels graph                               module Test.Unit.NewDependenciesAdvancedQuickCheckSpec 
  hasModule graph                               module Test.Unit.NewDependenciesAdvancedQuickCheckSpec 
  let level = computeDependencyLevel graph module Test.Unit.NewDependenciesAdvancedQuickCheckSpec = getTransitiveDependencies graph module Test.Unit.NewDependenciesAdvancedQuickCheckSpec L.all (\dep -> computeDependencyLevel graph dep < level) dependencies
...
hasModule graph                               module Test.Unit.NewDependenciesAdvancedQuickCheckSpec Map.member module Test.Unit.NewDependenciesAdvancedQuickCheckSpec graph)
...
getDirectDependencies graph                               module Test.Unit.NewDependenciesAdvancedQuickCheckSpec 
case Map.lookup module Test.Unit.NewDependenciesAdvancedQuickCheckSpec graph) of
    Just deps -> Set.toList deps
    Nothing -> []

getTransitiveDependencies :: DependencyGraph -> String -> [String]
getTransitiveDependencies graph                               module Test.Unit.NewDependenciesAdvancedQuickCheckSpec 
  let direct = getDirectDependencies graph module Test.Unit.NewDependenciesAdvancedQuickCheckSpec = concatMap (getTransitiveDependencies graph) direct
...
let currentDeps = Map.findWithDefault Set.empty from (moduleDependencies graph)
  ...
  in property $ graph {                               moduleDependencies = Map.insert from newDeps (moduleDependencies graph) }
