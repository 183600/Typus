...
-- | Mathematical property tests for SourceLocation module Test.Unit.NewSourceLocationMathCoreQuickCheckSpec Test.Unit.NewSourceLocationMathCoreQuickCheckSpec where
import Test.Tasty
...
prop_sourcespan_ordering_consistent start1 end1 start2                               end2 =
  ...
  in property $ property $ (startCompare == EQ) ==> (endCompare == compare span1 span2)
