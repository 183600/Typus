...
-- | Cross-module Test.Unit.NewComprehensiveCoreQuickCheckSpec property: Utils + SourceLocation
...
-- | Cross-module Test.Unit.NewComprehensiveCoreQuickCheckSpec property: Parser + SourceLocation
...
-- | Cross-module Test.Unit.NewComprehensiveCoreQuickCheckSpec property: Utils + Parser
