...
-- | QuickCheck tests for Dependent Types module Test.Unit.NewFreshDependentTypesQuickCheckSpec Test.Unit.NewFreshDependentTypesQuickCheckSpec where
import Test.Tasty
...
typeValidationProperties = testGroup "Type Validation Properties"
  ...
  ,             testProperty "constraint validation is consistent" $
    ...
    ,             testCase "complex dependent type validation" $ do
...
data                               TypeConstraint = EqualityConstraint String String
