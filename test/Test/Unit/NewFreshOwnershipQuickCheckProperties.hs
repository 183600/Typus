...
-- | QuickCheck tests for Ownership analysis module
...
testSuite :: TestTree
testSuite = testGroup "New Ownership QuickCheck Properties"
  [ ownershipAnalysisProperties
  , ownershipTransferProperties
  , ownershipPolicyProperties
  , ownershipSetProperties
  , ownershipIntegrationProperties
  ]
...
ownershipIntegrationProperties = testGroup "Ownership Integration Properties"
  ...
  , testCase "ownership tracking with source locations" $
    do
      let pos = startPos
