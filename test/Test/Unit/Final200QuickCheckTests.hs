...
module Test.Unit.Final200QuickCheckTests where
...
-- | 组合所有测试
final200QuickCheckTests :: TestTree
final200QuickCheckTests = testGroup "Final 200 QuickCheck Tests"
  ...
  , testProperty "parser test 11" prop_parse_identifier_basic
  , testProperty "parser test 12" prop_parse_identifier_basic
  , testProperty "parser test 13" prop_parse_identifier_basic
  , testProperty "parser test 14" prop_parse_identifier_basic
  , testProperty "parser test 15" prop_parse_identifier_basic
  , testProperty "parser test 16" prop_parse_identifier_basic
  , testProperty "parser test 17" prop_parse_identifier_basic
  , testProperty "parser test 18" prop_parse_identifier_basic
  , testProperty "parser test 19" prop_parse_identifier_basic
  , testProperty "parser test 20" prop_parse_identifier_basic
  , testProperty "parser test 21" prop_parse_identifier_basic
  , testProperty "parser test 22" prop_parse_identifier_basic
  , testProperty "parser test 23" prop_parse_identifier_basic
  , testProperty "parser test 24" prop_parse_identifier_basic
  , testProperty "parser test 25" prop_parse_identifier_basic
  , testProperty "parser test 26" prop_parse_identifier_basic
  , testProperty "parser test 27" prop_parse_identifier_basic
  , testProperty "parser test 28" prop_parse_identifier_basic
  , testProperty "parser test 29" prop_parse_identifier_basic
  , testProperty "parser test 30" prop_parse_identifier_basic
  , testProperty "parser test 31" prop_parse_identifier_basic
  , testProperty "parser test 32" prop_parse_identifier_basic
  , testProperty "parser test 33" prop_parse_identifier_basic
  , testProperty "parser test 34" prop_parse_identifier_basic
  , testProperty "parser test 35" prop_parse_identifier_basic
  , testProperty "parser test 36" prop_parse_identifier_basic
  , testProperty "parser test 37" prop_parse_identifier_basic
  , testProperty "parser test 38" prop_parse_identifier_basic
  , testProperty "parser test 39" prop_parse_identifier_basic
  , testProperty "parser test 40" prop_parse_identifier_basic
  , testProperty "compiler core test 1" prop_compile_basic
  , testProperty "compiler core test 2" prop_compile_basic
  , testProperty "compiler core test 3" prop_compile_basic
  , testProperty "compiler core test 4" prop_compile_basic
  , testProperty "compiler core test 5" prop_compile_basic
  , testProperty "compiler core test 6" prop_compile_basic
  , testProperty "compiler core test 7" prop_compile_basic
  , testProperty "compiler core test 8" prop_compile_basic
  , testProperty "compiler core test 9" prop_compile_basic
  , testProperty "compiler core test 10" prop_compile_basic
  , testProperty "compiler core test 11" prop_compile_basic
  , testProperty "compiler core test 12" prop_compile_basic
  , testProperty "compiler core test 13" prop_compile_basic
  , testProperty "compiler core test 14" prop_compile_basic
  , testProperty "compiler core test 15" prop_compile_basic
  , testProperty "compiler core test 16" prop_compile_basic
  , testProperty "compiler core test 17" prop_compile_basic
  , testProperty "compiler core test 18" prop_compile_basic
  , testProperty "compiler core test 19" prop_compile_basic
  , testProperty "compiler core test 20" prop_compile_basic
  , testProperty "compiler core test 21" prop_compile_basic
  , testProperty "compiler core test 22" prop_compile_basic
  , testProperty "compiler core test 23" prop_compile_basic
  , testProperty "compiler core test 24" prop_compile_basic
  , testProperty "compiler core test 25" prop_compile_basic
  , testProperty "compiler core test 26" prop_compile_basic
  , testProperty "compiler core test 27" prop_compile_basic
  , testProperty "compiler core test 28" prop_compile_basic
  , testProperty "compiler core test 29" prop_compile_basic
  , testProperty "compiler core test 30" prop_compile_basic
  , testProperty "compiler core test 31" prop_compile_basic
  , testProperty "compiler core test 32" prop_compile_basic
  , testProperty "compiler core test 33" prop_compile_basic
  , testProperty "compiler core test 34" prop_compile_basic
  , testProperty "compiler core test 35" prop_compile_basic
  , testProperty "compiler core test 36" prop_compile_basic
  , testProperty "compiler core test 37" prop_compile_basic
  , testProperty "compiler core test 38" prop_compile_basic
  , testProperty "compiler core test 39" prop_compile_basic
  , testProperty "compiler core test 40" prop_compile_basic
  , testProperty "dependency analysis test 1" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 2" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 3" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 4" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 5" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 6" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 7" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 8" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 9" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 10" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 11" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 12" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 13" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 14" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 15" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 16" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 17" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 18" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 19" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 20" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 21" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 22" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 23" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 24" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 25" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 26" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 27" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 28" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 29" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 30" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 31" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 32" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 33" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 34" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 35" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 36" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 37" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 38" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 39" prop_dependency_analysis_basic
  , testProperty "dependency analysis test 40" prop_dependency_analysis_basic
  , testProperty "ownership analysis test 1" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 2" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 3" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 4" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 5" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 6" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 7" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 8" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 9" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 10" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 11" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 12" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 13" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 14" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 15" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 16" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 17" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 18" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 19" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 20" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 21" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 22" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 23" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 24" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 25" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 26" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 27" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 28" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 29" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 30" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 31" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 32" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 33" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 34" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 35" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 36" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 37" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 38" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 39" prop_ownership_analysis_basic
  , testProperty "ownership analysis test 40" prop_ownership_analysis_basic
  , testProperty "error handling test 1" prop_error_handler_basic
  , testProperty "error handling test 2" prop_error_handler_basic
  , testProperty "error handling test 3" prop_error_handler_basic
  , testProperty "error handling test 4" prop_error_handler_basic
  , testProperty "error handling test 5" prop_error_handler_basic
  , testProperty "error handling test 6" prop_error_handler_basic
  , testProperty "error handling test 7" prop_error_handler_basic
  , testProperty "error handling test 8" prop_error_handler_basic
  , testProperty "error handling test 9" prop_error_handler_basic
  , testProperty "error handling test 10" prop_error_handler_basic
  , testProperty "error handling test 11" prop_error_handler_basic
  , testProperty "error handling test 12" prop_error_handler_basic
  , testProperty "error handling test 13" prop_error_handler_basic
  , testProperty "error handling test 14" prop_error_handler_basic
  , testProperty "error handling test 15" prop_error_handler_basic
  , testProperty "error handling test 16" prop_error_handler_basic
  , testProperty "error handling test 17" prop_error_handler_basic
  , testProperty "error handling test 18" prop_error_handler_basic
  , testProperty "error handling test 19" prop_error_handler_basic
  , testProperty "error handling test 20" prop_error_handler_basic
  , testProperty "error handling test 21" prop_error_handler_basic
  , testProperty "error handling test 22" prop_error_handler_basic
  , testProperty "error handling test 23" prop_error_handler_basic
  , testProperty "error handling test 24" prop_error_handler_basic
  , testProperty "error handling test 25" prop_error_handler_basic
  , testProperty "error handling test 26" prop_error_handler_basic
  , testProperty "error handling test 27" prop_error_handler_basic
  , testProperty "error handling test 28" prop_error_handler_basic
  , testProperty "error handling test 29" prop_error_handler_basic
  , testProperty "error handling test 30" prop_error_handler_basic
  , testProperty "error handling test 31" prop_error_handler_basic
  , testProperty "error handling test 32" prop_error_handler_basic
  , testProperty "error handling test 33" prop_error_handler_basic
  , testProperty "error handling test 34" prop_error_handler_basic
  , testProperty "error handling test 35" prop_error_handler_basic
  , testProperty "error handling test 36" prop_error_handler_basic
  , testProperty "error handling test 37" prop_error_handler_basic
  , testProperty "error handling test 38" prop_error_handler_basic
  , testProperty "error handling test 39" prop_error_handler_basic
  , testProperty "error handling test 40" prop_error_handler_basic
  ]
