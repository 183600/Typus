module Test.Unit.ToolchainIntegrationSpec where


import Test.Tasty 
import Test.Tasty.HUnit (testCase, assertFailure, assertBool, (@?=))
import Test.Tasty.QuickCheck 
import Test.QuickCheck (Gen, choose, vectorOf, elements, Arbitrary(..), (==>), forAll, counterexample, classify, Gen, arbitrary, choose, listOf, elements)
...
import SourceLocation (SourcePos(..), SourceSpan)
        ...
        ,             testCase "Go module Test.Unit.ToolchainIntegrationSpec $ do
          ...
          case result of
            ...
            Left err -> assertBool $ "Should handle module Test.Unit.ToolchainIntegrationSpec " ++ show err
