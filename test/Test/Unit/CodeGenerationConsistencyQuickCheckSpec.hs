module Test.Unit.CodeGenerationConsistencyQuickCheckSpec where
...
test_generate_complex_program =             testCase "generate complex program" $ do
        ...
        , "  value: Int;"
        , "}"
        , "func process(d: Data (SourceSpan (SourcePos 1 1 0 [] (SourcePos 1 1 0): Int {"
        , "  if d.value > 0 {"
        , "    return d.value * 2;"
        , "  } else {"
        , "    return 0;"
...
test_go_module_rendering =             testCase "Go module Test.Unit.CodeGenerationConsistencyQuickCheckSpec $ do
