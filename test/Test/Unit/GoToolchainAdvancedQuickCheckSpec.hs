module Test.Unit.GoToolchainAdvancedQuickCheckSpec where
import Test.Tasty 
...
-- Property: goModContents contains module Test.Unit.GoToolchainAdvancedQuickCheckSpec
prop_goModContentsContainsModule :: Bool
                              prop_goModContentsContainsModule = "module Test.Unit.GoToolchainAdvancedQuickCheckSpec `L.isInfixOf` goModContents
...
tests =   testGroup "GoToolchain Advanced QuickCheck Tests"
  [ testGroup "Module Properties"
    ...
    ,             testProperty "goModContents contains module Test.Unit.GoToolchainAdvancedQuickCheckSpec prop_goModContentsContainsModule
  ...
  , testGroup "Unit Tests"
    [             testCase "goModContents has correct format" $ do
                    assertBool "Should contain module Test.Unit.GoToolchainAdvancedQuickCheckSpec $ "module Test.Unit.GoToolchainAdvancedQuickCheckSpec `L.isInfixOf` goModContents
...
assertBool "Should have multiple lines" $ L.length (lines goModContents) >= 2
      ...
      ,             testCase "Go module Test.Unit.GoToolchainAdvancedQuickCheckSpec structure" $ do
                    let lines' = lines goModContents
        L.length lines' @?= 2
        L.head lines' @?= "module Test.Unit.GoToolchainAdvancedQuickCheckSpec
        last lines' @?= "go 1.21"
