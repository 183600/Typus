module Test.Unit.ParserErrorRecoveryAdvancedQuickCheckSpec where
...
tests =  testGroup "Parser Error Recovery Advanced QuickCheck Tests"
  ...
  ,             testProperty "Parser handles extremely long lines in property $ error conditions" prop_parserHandlesLongLines
