module Test.Unit.TypeSystemInteractionSpec (tests) where
...
import Compiler.TypeChecker (buildTypeEnv, buildTypeEnvFromPairs)
import Compiler.DependentTypeChecker (checkDependentTypes)
import Compiler.OwnershipChecker (checkOwnership)

-- | Test complex interactions between type system components
tests :: TestTree
tests =
