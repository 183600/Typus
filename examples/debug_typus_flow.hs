-- This script simulates the exact flow in typus to debug the import issue
...
main :: IO ()
main = do
    -- Simulate a TypusFile with the content from our test file
    ...
    putStrLn "Simulating typus flow..."
