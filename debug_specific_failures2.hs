...
main = do
    ...
    putStrLn $ "案例1: isCompleteStringLiteral "\\\\" = " ++ show (Utils.isCompleteStringLiteral "\\")
    
    -- 案例2: isCompleteStringLiteral invalid 失败案例 "\""
    putStrLn $ "案例2: isCompleteStringLiteral \"\\\"\" = " ++ show (Utils.isCompleteStringLiteral "\"")
    
    -- 案例3: isProblematicUnclosedString 失败案例 "\""
    putStrLn $ "案例3: isProblematicUnclosedString \"\\\"\" = " ++ show (Utils.isProblematicUnclosedString "\"")
